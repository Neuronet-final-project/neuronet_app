...
/// 3-step forgot password flow for Guardian: Email → OTP → New Password
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: NeuroColors.guardianPrimaryLight.withValues(alpha: 0.18),
              ),
            ),
          ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: NeuroColors.guardianPrimary.withValues(alpha: 0.25),
                                blurRadius: 40,
                                ...
                                _buildTextField(
                                  ...
                                  suffixIcon: IconButton(
                                    icon: Icon(
                                      ...
                                      color: NeuroColors.guardianPrimary, size: 20,
                                    ),
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(14),
          borderSide: const BorderSide(color: NeuroColors.guardianPrimary, width: 1.8),
        ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: enabled
                ? [
                    BoxShadow(
                      color: NeuroColors.guardianPrimary.withValues(alpha: 0.35),
                      blurRadius: 16,
